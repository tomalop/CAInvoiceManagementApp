import { InvoiceItemVm, DiscountType, TaxType, ICreateInvoiceCommand } from './api';
...
export const getTotal = (invoiceData: ICreateInvoiceCommand) => {
...
export const getBalance = (invoiceData: ICreateInvoiceCommand) => {
